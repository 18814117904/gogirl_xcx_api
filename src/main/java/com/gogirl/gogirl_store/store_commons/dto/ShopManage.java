...
public class ShopManage implements Serializable {
	...
	public String getShopEnvironmentPhotos() {
		return shopEnvironmentPhotos;
	}

	public void setShopEnvironmentPhotos(String shopEnvironmentPhotos) {
		this.shopEnvironmentPhotos = shopEnvironmentPhotos;
	}
