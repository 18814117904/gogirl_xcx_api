...
public abstract class CalculateBalanceXcx {
	...
	public CalculateBalanceXcx() {
		super();
	}
	
	public CalculateBalanceXcx(CustomerBalance balance) {
		super();
	...
	public abstract JsonResult<CustomerBalance> calculateBalance(CustomerBalance balance,int amount, Integer orderId) throws Exception ;
	public abstract JsonResult<CustomerBalanceRecord> saveRecord(CustomerBalance balance,int charge_balance,String orderId);
